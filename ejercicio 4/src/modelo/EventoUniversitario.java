...
public class EventoUniversitario implements Serializable {
    ...
    public double calcularCostoMateriales(List<? extends Actividad> actividades){
        ...
        System.out.println("La cantidad de actividades del tipo "+actividades.get(0).getClass().getSimpleName()+" es de "+actividades.size()+" y el costo de materiales es de "+costoActividad);
